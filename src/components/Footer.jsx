...
const Footer = () => {
  ...
  return (
    <footer className="bg-heritage-900 text-white pt-16 pb-8">
      <div className="section-container">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* Company Info */}
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-br from-warmth-500 to-warmth-600 rounded-full flex items-center justify-center shadow-lg">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-sans text-warmth-300">
                  Rempah Nusantara
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <a
                ...
                className="w-10 h-10 bg-warmth-500 hover:bg-warmth-400 rounded-full flex items-center justify-center transition-colors"
                aria-label="WhatsApp"
              >
            ...
            <ul className="space-y-3 text-warmth-200 font-body">
              <li>
                <a
                  ...
                  className="hover:text-warmth-300 transition-colors"
                >
                  {COMPANY_INFO.phone}
                </a>
              </li>
