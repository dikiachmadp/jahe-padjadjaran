          ...
          >
            ...
            <div className="flex flex-col">
              <span className={`font-display font-bold text-lg transition-colors ${
                isScrolled ? 'text-heritage-900' : 'text-white'
              }`}>
                Jahe Padjajaran
              </span>
              <span className={`text-xs font-sans transition-colors ${
                isScrolled ? 'text-heritage-600' : 'text-warmth-100'
              }`}>
                Rempah Nusantara
              </span>
            </div>
          ...
          >
            {NAVIGATION.map((item, index) => (
              <button
                ...
                className={`font-sans font-medium transition-colors hover:text-warmth-600 ${
                  isScrolled ? 'text-heritage-800' : 'text-white'
                }`}
