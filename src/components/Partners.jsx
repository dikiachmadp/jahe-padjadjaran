  ...
  return (
    <section id="partners" className="py-20 bg-white">
      <div className="section-container">
        ...
        >
          <div className="bg-gradient-to-br from-warmth-50 to-warmth-100 rounded-2xl p-6 text-center shadow-lg">
          ...
          <div className="bg-gradient-to-br from-heritage-50 to-heritage-100 rounded-2xl p-6 text-center shadow-lg">
            <div className="text-4xl font-display font-bold text-heritage-600 mb-2">
              2021
            </div>
            <div className="text-heritage-700 font-body">
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl p-6 text-center shadow-lg">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-sky-100 rounded-2xl p-6 text-center shadow-lg">
          ...
          {PARTNERS.map((partner, index) => (
            ...
            >
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-warmth-400 to-warmth-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-warmth-500 to-warmth-600 rounded-3xl p-8 md:p-12 text-white shadow-2xl"
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {t('partners.benefits.list').map((benefit, index) => (
              ...
              >
                ...
                <p className="text-warmth-100 font-body">
                  {benefit.description}
                </p>
              </div>
            ))}
