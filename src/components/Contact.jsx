      ...
      <div className="section-container">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-display font-bold text-heritage-900 mb-6">
            Mari Bermitra Bersama
          </h2>
          <p className="text-xl text-heritage-700 max-w-3xl mx-auto font-body leading-relaxed">
            Kami terbuka untuk peluang kemitraan dan distribusi. Hubungi kami untuk
            informasi lebih lanjut tentang produk dan skema kerja sama
          </p>
        </motion.div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-warmth-100 font-body text-lg leading-relaxed">
                Bergabunglah dengan jaringan distribusi kami dan kembangkan bisnis
                Anda dengan produk berkualitas tinggi yang diminati pasar
              </p>
            </div>
        ...
        >
          <p className="text-heritage-700 font-body text-lg mb-4">
            Dipercaya oleh mitra distribusi terkemuka di Jabodetabek dan Jawa Barat
          </p>
